...
| Docker image (tag) | `docker.io/ahmed3142/gridwise-llm:1.0.0` (multi-arch: linux/amd64 + linux/arm64). It is private until the deadline and public after. |
| Docker image (digest) | `docker.io/ahmed3142/gridwise-llm@sha256:d66943e8398841a0915451d22766268db8b2eadd37a8f1afc07c6c046b2adcd4` |
